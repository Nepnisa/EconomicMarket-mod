...
public class AuctionManager {
    ...
    public static List<AuctionItem> load() {
        ...
        try {
            ...
            return GSON.fromJson(json, new TypeToken<List<AuctionItem>>(){}.getType());
    ...
    public static void save() {
        try {
            ...
            Files.writeString(FILE, GSON.toJson(auctions));
        ...
        while (it.hasNext()) {
            ...
            if (a.isExpired()) {
                if (a.currentBid > 0 && a.currentBidderUuid != null) {
                    ...
                    if (winner != null) {
                        if (!winner.getInventory().insertStack(a.item.copy())) {
                            winner.dropItem(a.item.copy(), false);
                        }
                    }
                    ...
                    a.finished = true;
                    a.winnerName = winner != null ? winner.getName().getString() : "";
                } else {
                    ServerPlayerEntity seller = server.getPlayerManager().getPlayer(a.sellerUuid);
                    if (seller != null) {
                        if (!seller.getInventory().insertStack(a.item.copy())) {
                            seller.dropItem(a.item.copy(), false);
                        }
